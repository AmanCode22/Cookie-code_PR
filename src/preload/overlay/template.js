...
'        <span style="color:var(--ck-text-dim);font-size:12px;">' + t('overlay.label.delayRange') + '</span>',
...
'    <div class="cuckoo-divider"></div>',
'    <div class="cuckoo-section">',
'      <label class="cuckoo-label">' + t('overlay.label.task') + '<span id="cuckoo-task-status" class="cuckoo-task-status cuckoo-hidden"><span class="cuckoo-spinner"></span>' + t('overlay.task.running') + '</span></label>',
